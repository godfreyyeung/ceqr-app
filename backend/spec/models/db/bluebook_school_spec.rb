...
RSpec.describe Db::BluebookSchool, type: :model do
  ...
  describe "#ps_schools_in_subdistricts" do
    it "returns an array of bluebooks that match subdistrict" do
      subdistricts = ["(2,1)"]

      ps_schools = Db::BluebookSchool.ps_schools_in_subdistricts(subdistricts)
  ...
  describe "#is_schools_in_subdistricts" do
    it "returns an array of bluebooks that match subdistrict" do
      subdistricts = ["(2,1)"]

      is_schools = Db::BluebookSchool.is_schools_in_subdistricts(subdistricts)
